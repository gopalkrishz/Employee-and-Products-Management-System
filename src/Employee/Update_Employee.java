...
class Update_Employee extends Add_Employee implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                conn con = new conn();
                String str = "update employee set name='"+t1.getText()+"',father_name='"+t2.getText()+"',age='"+age+"',dob='"+dat+"',address='"+t3.getText()+"',phone='"+t4.getText()+"',emailID='"+t5.getText()+"',education='"+t6.getText()+"',jobpost='"+t7.getText()+"',aadhaarno='"+t8.getText()+"',empid='"+t9.getText()+"' where empid='"+id_emp+"'";
