...
class RemoveStocks implements ActionListener{
    JFrame f;
    JTextField t;
    ...
    RemoveStocks(){
        ...
        l5.setLayout(null);
//        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("icons/homes.jpeg"));
//        l5.setIcon(img);
        f.add(l5);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "select stockname,quantity,manf from stocks where IFS ='"+t.getText()+"' ";
        ...
        if(ae.getSource()==b1){
            try{
                conn con = new conn();
                String str = "delete from stocks where empid = '"+t.getText()+"'";
